...
public class ConversionLogic {
    ...
    public static Set<String> getDoc(String document) {
        ...
        JsonNode eachDoc = MapperUtil.fromObject(document, JsonNode.class);
        String textValue = eachDoc.textValue();
        JsonNode valueNode = MapperUtil.getJsonNodeFromString(textValue);
        MetaObjectValue metaObjectValue = MapperUtil.fromObject(valueNode, MetaObjectValue.class);
